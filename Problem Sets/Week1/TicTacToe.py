...
def check_win_horizontal(board) -> int:
    """To check whether a player has won horizontally

    Parameters
    ----------
    board: list
        the board to check whether there is a player has won horizontally

    Returns
    -------
    int
        the index of the winner. 0 means no winner found.
    """
...
def main() -> int:
    board = [
        0,
        0,
        0,  # top row:    indices 0, 1, 2
        0,
        0,
        0,  # middle row: indices 3, 4, 5
        0,
        0,
        0,
